...
toast = wrapper2.querySelector(".toast"),
...
window.onload = ()=>{
    function ajax(){
        ...
        xhr.onload = ()=>{ //once ajax loaded
            ...
            if(xhr.status == 200 && xhr.status < 300){
                ...
                title.innerText = "Vous etes en lignes ! ";
                subTitle.innerText = "Bravo! Internet est stable.";
    ...
    function offline(){ //function for offline
        ...
        title.innerText = "Vous etes hors-ligne";
        subTitle.innerText = "Opps! Internet à crash..";
